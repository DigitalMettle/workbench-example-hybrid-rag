...
# Install Miniconda (ARM64 compatible)
...
# Install additional packages using pip (no sudo pip in Python Basic)
pip install anyio==4.3.0 pymilvus==2.3.1 transformers==4.40.0 marshmallow==3.20.1
